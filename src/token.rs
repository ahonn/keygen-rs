...
pub struct TokenAttributes {
    ...
    #[serde(rename = "maxDeactivations")]
    pub max_deactivations: Option<u32>,
    pub deactivations: Option<u32>,
...
impl Token {
    pub(crate) fn from(data: KeygenResponseData<TokenAttributes>) -> Token {
        Token {
            ...
            max_activations: data.attributes.max_activations,
            activations: data.attributes.activations,
            max_deactivations: data.attributes.max_deactivations,
            deactivations: data.attributes.deactivations,
